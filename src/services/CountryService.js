...
const countryHotel = {
  "Argentina": 'Hostel Carlos Gardel',
  "Australia": "Gilligan's",
  "Austria": 'Eventhotel Pyramide',
  "Barbados": "Class'Eco Charleroi",
  "Belgium": 'Ramada Sofia',
  "Bulgaria": 'Varandas do Vidigal',
  "Brazil": 'BoHo Prague Hotel',
  "Canada": 'Hotel Arena Palace',
  "Cyprus": 'Limanaki Beach',
  "Cuba": 'Hotel Sol Palmeras',
  "Dominican Republic": 'Catalonia Domingo',
  "Germany": 'Hotel "Am Markt"',
  "Greece": 'Santorini Royal Suites',
  "Georgia": 'Chito-Gvrito',
  "Egypt": 'Luna Sharm Hotel',
  "Estonia": 'Hedon',
  "Jamaica": 'Firefly Beach Cottages',
  "Fijis": 'Nadi Bay Resort Hotel',
  "Finland": 'CheapSleep Helsinki',
  "France": 'Hôtel Pastoral',
  "Iceland": 'Moar Guesthouse',
  "Italy": 'Domus Sessoriana',
  "Montenegro": 'Regent Porto Montenegro',
  "Norway": 'Vestlia Resort',
  "Republic of Tunisia": 'Hotel Marhaba Beach',
  "Republic of Malta": 'Solana Hotel & Spa',
  "Madagascar": 'Hotel Arc en Ciel',
  "Netherlands": 'Hostel Sleep Amsterdam',
  "Turkey": 'Side Premium',
  "Spain": 'Hotel Marina',
  "Sri Lanka": 'Liyya Water Villas',
  "Switzerland": "Hotel Dell'Angelo",
  "Sweden": 'Hotell Slottsbacken',
  "USA": 'New World Hotel'
}
